...
def test_01():
    ...
    dataset = pd.read_csv(f"{FOLDER}/data/input/auto_mpg.csv")
    ...
    with open(f"{FOLDER}/data/output/mlp.pkl", "rb") as file:
        mlp = pickle.load(file)

    with open(f"{FOLDER}/data/output/features_scaler.pkl", "rb") as file:
